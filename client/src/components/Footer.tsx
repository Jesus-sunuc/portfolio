const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/jesús-st6",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      url: "mailto:ms.jesustuyuc@gmail.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              ...
              solutions that bridge technology and entrepreneurship.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p className="flex items-center">
                ...
                150 College Avenue, Ephraim, Utah
              </p>
              <a
