const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/jesus-sunuc",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/jesussunuc",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      url: "mailto:jesus.sunuc@example.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              ...
              solutions that bridge technology and entrepreneurship. Currently
              seeking opportunities to grow my career in the United States.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              >
                ...
                jesus.sunuc@example.com
              </a>
              <p className="text-sm text-gray-400 mt-4">
                Open to opportunities in full-stack development, cybersecurity,
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              <p>&copy; {currentYear} Jesús Sunuc. All rights reserved.</p>
              <p className="mt-1">
